...
// User Management
    ...
    Route::get('user/view-profile/{user_id?}', [UserController::class, 'profile'])->name('view-profile');
...
// Course Management
    Route::middleware(['role:Management|Teacher'])->group(function () {
        ...
        Route::delete('courses/{id}/soft-delete', [CourseController::class, 'softDelete'])->name('courses.softDelete');
