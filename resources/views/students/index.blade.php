...
<div class="content card">
                            ...
                            <div class="card-body">
                                ...
                                <form id="students_store">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="admission_no">Admission No <span
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="seat_type">Seat Type <span
                                                        class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="course_id" name="course_id">
                                                    @if(Auth()->user()->role->name !== "Management") readonly @endif
                                                    required>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="batch_id" name="batch_id"
                                                    onchange="seatFromBatchCheck(this.value);" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <textarea class="form-control" id="address" name="address" rows="1"
                                                        maxlength="100" aria-label="Address"></textarea>
    ...
    <script>
        function editModal(val) {
            ...
            $('#address').val(address);
            if (gender == 'male') { $('#gender_male').prop('checked', true); }
            else if (gender == 'female') {// Set gender to female
